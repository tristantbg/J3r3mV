module.exports = function(grunt) {
    grunt.initConfig({
        concat: {
            plugins: {
                src: ['assets/oembed/oembed.min.js', 'assets/lib/flickity/dist/flickity.pkgd.min.js','assets/lib/js-signals/dist/signals.min.js', 'assets/lib/hasher/dist/js/hasher.min.js'],
